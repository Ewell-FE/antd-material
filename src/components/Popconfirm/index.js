            ...
            <div style={{ display: 'inline-block' }}>
                ...
                >
                    ...
                    <div className={classes.footer}>
                        <Button size="small" style={{ minWidth: 36 }} onClick={(e) => this.handleCancel(e)}>{cancelText || locale.cancelText}</Button>
                        <Button type={okType || "Primary"} size="small" style={{ minWidth: 36 }} onClick={(e) => this.handleSure(e)}>{okText || locale.okText}</Button>
                    </div>
                </Popover>
            </div>
