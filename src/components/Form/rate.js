...
@withStyles(styles, {name: 'MuiFormRateAnt'})
export default class renderRate extends Component {
    render() {
        const {classes, field, isError, isWarn} = this.props
        let otherField = omit(field, ['input', 'labelWidth', 'wrapperWidth', 'meta', 'layout', 'label','type','value'])
        return (
            <div className={classes[field.layout]}>
                ...
                <div className="input" style={{width:field.wrapperWidth}}><Rate
