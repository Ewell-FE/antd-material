...
@withStyles(styles, {name: 'MuiFormRadioGroupAnt'})
export default class renderRadioGroup extends Component {
    render() {
        ...
        return (
            <div className={classes[field.layout]}>
                ...
                <div className="input" style={{width:field.wrapperWidth}}><RadioGroup
