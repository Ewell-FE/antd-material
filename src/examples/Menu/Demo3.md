    ...
    render() {
        return (
            <Menu mode="inline"
                ...
                <Menu.SubMenu key="side2" title={<span><i className="fa fa-leaf" aria-hidden="true" style={{marginRight:'10px'}}></i>导航二</span>}>
                ...
                <Menu.SubMenu key="side4" title={<span><i className="fa fa-tty" aria-hidden="true" style={{marginRight:'10px'}}></i>导航三</span>}>
