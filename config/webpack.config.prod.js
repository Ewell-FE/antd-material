...
module.exports = {
                                        ...
                                        },
                                        {
                                            ...
                                            options: {
                                                ...
                                                modifyVars: {
                                                    ...
                                                    "text-color": "#333333",
                                                    'icon-url': '"' + pkg.root + '/static/iconfont/iconfont"',
                                                }
                                            }
                                        }
                                    ],
    ...
    plugins: [
        new webpack.ProvidePlugin({
            "axios": path.resolve(paths.appSrc, "util/axios.js"),
            "Ewell": path.resolve(paths.appSrc, "util/base.js"),
            "AuthorityComponent": path.resolve(paths.appSrc, "util/AuthorityComponent.js"),
            "$": "jquery",
            "jQuery": "jquery"
        }),
